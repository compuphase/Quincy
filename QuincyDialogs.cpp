...
SettingsDlg::SettingsDlg( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_chkAutoTransfer = new wxCheckBox( m_pBuild, wxID_ANY, wxT("Automatically &transfer after build"), wxDefaultPosition, wxDefaultSize, 0 );
	m_chkAutoTransfer->SetToolTip( wxT("Transfer compiled scripts to the target device") );

	sizerBuildOptions->Add( m_chkAutoTransfer, 0, wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	...
	m_gridSnippets->SetColLabelAlignment( wxALIGN_CENTER, wxALIGN_CENTER );

	// Rows
	m_gridSnippets->EnableDragRowSize( false );
	m_gridSnippets->SetRowLabelSize( 0 );
	m_gridSnippets->SetRowLabelAlignment( wxALIGN_CENTER, wxALIGN_CENTER );
	...
	m_chkCreateReport = new wxCheckBox( m_pOptions, wxID_ANY, wxT("Create s&ymbol report && documentation"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	bOptionsSizer->Add( m_chkCreateReport, 0, wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	...
	m_UserPDFReader->SetToolTip( wxT("The PDF reader is used to show the online documentation") );
	...
	m_UserReaderPath->SetToolTip( wxT("Full path to the PDF reader application") );

	bSizerHelp->Add( m_UserReaderPath, 1, wxTOP|wxBOTTOM|wxLEFT, 5 );

	m_UserReaderBrowse = new wxBitmapButton( m_pOptions, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|0 );

	m_UserReaderBrowse->SetBitmap( wxBitmap( tb_open_xpm ) );
...
SampleBrowser::SampleBrowser( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_htmlSample = new wxHtmlWindow( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHW_SCROLLBAR_AUTO );
